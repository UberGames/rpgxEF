...
qhandle_t				  tr_loading1;
qhandle_t					tr_loading2;
qhandle_t					tr_loading3;
qhandle_t					tr_loading4;
qhandle_t					tr_loading5;
...
static void M_TransporterMenu_Graphics(void)
{
	...
	UI_DrawHandlePic(366, 208, 243, 212, tr_loading2);
	trap_R_SetColor(colorTable[CT_LTGOLD1]);
	UI_DrawHandlePic(366, 208, 243, 212, tr_loading3);
	UI_DrawHandlePic(366, 208, 243, 212, tr_loading1);
	trap_R_SetColor(colorTable[CT_DKBLUE1]);
	UI_DrawHandlePic(366, 208, 243, 212, tr_loading4);
	trap_R_SetColor(colorTable[CT_DKORANGE]);
	UI_DrawHandlePic(366, 208, 243, 212, tr_loading5);
...
void UI_TransporterMenu_Cache(void)
{
	...
	tr_loading1 = trap_R_RegisterShaderNoMip("menu/new/nav_y.tga");
	tr_loading2 = trap_R_RegisterShaderNoMip("menu/new/nav_mb.tga");
	tr_loading3 = trap_R_RegisterShaderNoMip("menu/new/nav_lb.tga");
	tr_loading4 = trap_R_RegisterShaderNoMip("menu/new/nav_db.tga");
	tr_loading5 = trap_R_RegisterShaderNoMip("menu/new/nab_o.tga");
	UI_LogFuncEnd();
}
