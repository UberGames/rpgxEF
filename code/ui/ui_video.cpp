...
static void GraphicsOptions_GetInitialVideo(void)
{
	...
	s_ivo.fullscreen = static_cast<qboolean>(s_graphicsoptions.fs.curvalue);
	s_ivo.extensions = static_cast<qboolean>(s_graphicsoptions.allow_extensions.curvalue);
...
static void VideoData2_MenuInit(void)
{
	...
	s_videodata2.gamma_slider.thumbName = (char*)PIC_SLIDER;
	...
	s_videodata2.screensize_slider.thumbName = (char*)PIC_SLIDER;
