...
float setup_menubuttons[8][2] = {
    {125, 62}, {125, 86},  {125, 109}, {300, 62},
    {300, 86}, {300, 109}, {482, 62},  {482, 86},
};

int32_t s_OffOnNone_Names[] = {MNT_OFF, MNT_ON, MNT_NONE};

int32_t s_Autoswitch_Names[] = {MNT_OFF, MNT_SAFE, MNT_BEST, MNT_NONE};
...
static struct { qhandle_t mon_bar; } s_controlsother;
...
menugraphics_s attackmenu_graphics[AMG_MAX] = {
    //	type		timer	x		y		width	height	file/text						graphic,
    //min		max	target	inc		style	color
    {MG_GRAPHIC, 0.0, 158, 280, 4, 32, "menu/common/square.tga", 0, 0, 0, 0, 0,
     0, 0, CT_VDKPURPLE1, NULL}, // AMG_MIDLEFT
    {MG_GRAPHIC, 0.0, 158, 180, 8, 97, "menu/common/square.tga", 0, 0, 0, 0, 0,
     0, 0, CT_VDKPURPLE1, NULL}, // AMG_UPPERLEFT
    {MG_GRAPHIC, 0.0, 158, 315, 8, 100, "menu/common/square.tga", 0, 0, 0, 0, 0,
     0, 0, CT_VDKPURPLE1, NULL}, // AMG_LOWERLEFT
    {MG_GRAPHIC, 0.0, 158, 164, 16, 16, "menu/common/corner_lu.tga", 0, 0, 0, 0,
     0, 0, 0, CT_VDKPURPLE1, NULL}, // AMG_UPPERCORNER
    {MG_GRAPHIC, 0.0, 158, 406, 32, 32, "menu/common/newswoosh.tga", 0, 0, 0, 0,
     0, 0, 0, CT_VDKPURPLE1, NULL}, // AMG_LOWERCORNER

    {MG_GRAPHIC, 0.0, 177, 164, 280, 8, "menu/common/square.tga", 0, 0, 0, 0, 0,
     0, 0, CT_VDKPURPLE1, NULL}, // AMG_UPPERTOP1ST
    {MG_GRAPHIC, 0.0, 175, 410, 282, 18, "menu/common/square.tga", 0, 0, 0, 0,
     0, 0, 0, CT_VDKPURPLE1, NULL}, // AMG_LOWERTOP1ST

    {MG_GRAPHIC, 0.0, 457, 164, 34, 8, "menu/common/square.tga", 0, 0, 0, 0, 0,
     0, 0, CT_VDKPURPLE1, NULL}, // AMG_UPPERTOP2ND
    {MG_GRAPHIC, 0.0, 457, 410, 34, 18, "menu/common/square.tga", 0, 0, 0, 0, 0,
     0, 0, CT_VDKPURPLE1, NULL}, // AMG_LOWERTOP2ND

    {MG_GRAPHIC, 0.0, 494, 164, 128, 128, "menu/common/swoosh_top.tga", 0, 0, 0,
     0, 0, 0, 0, CT_VDKPURPLE1, NULL}, // AMG_UPPERSWOOP
    {MG_GRAPHIC, 0.0, 483, 403, 128, 32, "menu/common/newswoosh_long.tga", 0, 0,
     0, 0, 0, 0, 0, CT_VDKPURPLE1, NULL}, // AMG_LOWERSWOOP

    {MG_GRAPHIC, 0.0, 501, 189, 110, 17, "menu/common/square.tga", 0, 0, 0, 0,
     0, 0, 0, CT_VDKPURPLE1, NULL}, // AMG_TOPRIGHT
    {MG_GRAPHIC, 0.0, 501, 383, 110, 17, "menu/common/square.tga", 0, 0, 0, 0,
     0, 0, 0, CT_VDKPURPLE1, NULL}, // AMG_BOTTOMRIGHT

    {MG_GRAPHIC, 0.0, 501, 206, 110, 177, "menu/common/square.tga", 0, 0, 0, 0,
     0, 0, 0, CT_VDKPURPLE1, NULL}, // AMG_PLAYERBKGRND
};
...
enum ui_controls2Save_e { SAVE_NOOP, SAVE_YES, SAVE_NO, SAVE_CANCEL };
...
static bind_t g_bindings[] = {
    {"+info", MNT_SHORTCUT_SCORES, ID_SHOWSCORES, ANIM_IDLE, K_TAB, -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"+use", MNT_SHORTCUT_USEOBJECT, ID_USEITEM, ANIM_IDLE, K_ENTER, -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"+speed", MNT_SHORTCUT_RUNWALK, ID_SPEED, ANIM_RUN, K_SHIFT, -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"+forward", MNT_SHORTCUT_WALKFORWARD, ID_FORWARD, ANIM_WALK, K_UPARROW, -1,
     -1, -1, MNT_SHORTCUT_KEY},
    {"+back", MNT_SHORTCUT_BACKPEDAL, ID_BACKPEDAL, ANIM_BACK, K_DOWNARROW, -1,
     -1, -1, MNT_SHORTCUT_KEY},
    {"+moveleft", MNT_SHORTCUT_STEPLEFT, ID_MOVELEFT, ANIM_STEPLEFT, ',', -1,
     -1, -1, MNT_SHORTCUT_KEY},
    {"+moveright", MNT_SHORTCUT_STEPRIGHT, ID_MOVERIGHT, ANIM_STEPRIGHT, '.',
     -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+moveup", MNT_SHORTCUT_UPJUMP, ID_MOVEUP, ANIM_JUMP, 'd', -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"+movedown", MNT_SHORTCUT_DOWNCROUCH, ID_MOVEDOWN, ANIM_CROUCH, 'c', -1,
     -1, -1, MNT_SHORTCUT_KEY},
    {"+left", MNT_SHORTCUT_TURNLEFT, ID_LEFT, ANIM_TURNLEFT, K_LEFTARROW, -1,
     -1, -1, MNT_SHORTCUT_KEY},
    {"+right", MNT_SHORTCUT_TURNRIGHT, ID_RIGHT, ANIM_TURNRIGHT, K_RIGHTARROW,
     -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+strafe", MNT_SHORTCUT_SIDESTEPTURN, ID_STRAFE, ANIM_IDLE, K_ALT, -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"+lookup", MNT_SHORTCUT_LOOKUP, ID_LOOKUP, ANIM_LOOKUP, K_PGDN, -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"+lookdown", MNT_SHORTCUT_LOOKDOWN, ID_LOOKDOWN, ANIM_LOOKDOWN, K_DEL, -1,
     -1, -1, MNT_SHORTCUT_KEY},
    {"laser", MNT_SHORTCUT_MOUSELOOK, ID_MOUSELOOK, ANIM_IDLE, 'r', -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"centerview", MNT_SHORTCUT_CENTERVIEW, ID_CENTERVIEW, ANIM_IDLE, K_END, -1,
     -1, -1, MNT_SHORTCUT_KEY},
    {"+zoom", MNT_SHORTCUT_ZOOMVIEW, ID_ZOOMVIEW, ANIM_IDLE, -1, -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"weapon 1", MNT_SHORTCUT_WEAPON1, ID_WEAPON1, ANIM_WEAPON1, '1', -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"weapon 2", MNT_SHORTCUT_WEAPON2, ID_WEAPON2, ANIM_WEAPON2, '2', -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"weapon 3", MNT_SHORTCUT_WEAPON3, ID_WEAPON3, ANIM_WEAPON3, '3', -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"weapon 4", MNT_SHORTCUT_WEAPON4, ID_WEAPON4, ANIM_WEAPON4, '4', -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"weapon 5", MNT_SHORTCUT_WEAPON5, ID_WEAPON5, ANIM_WEAPON5, '5', -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"weapon 0", MNT_SHORTCUT_WEAPON0, ID_WEAPON0, ANIM_WEAPON10, '0', -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"+attack", MNT_SHORTCUT_ATTACK, ID_ATTACK, ANIM_ATTACK, K_CTRL, -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"+altattack", MNT_SHORTCUT_ALTATTCK, ID_ALT_ATTACK, ANIM_ATTACK, K_MOUSE2,
     -1, -1, -1, MNT_SHORTCUT_KEY},
    {"weapprev", MNT_SHORTCUT_PREVWEAPON, ID_WEAPPREV, ANIM_IDLE, '[', -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"weapnext", MNT_SHORTCUT_NEXTWEAPON, ID_WEAPNEXT, ANIM_IDLE, ']', -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"+button3", MNT_SHORTCUT_GESTURE, ID_GESTURE, ANIM_GESTURE, K_MOUSE3, -1,
     -1, -1, MNT_SHORTCUT_KEY},
    {"equip", MNT_SHORTCUT_EQUIP, ID_EQUIP, ANIM_IDLE, 'p', -1, -1, -1,
     MNT_SHORTCUT_KEY},
    // RPG-X | Marcin | 04/12/2008
    {"drop", MNT_SHORTCUT_DROP, ID_DROP, ANIM_IDLE, 'g', -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"messagemode", MNT_SHORTCUT_CHAT, ID_CHAT, ANIM_CHAT, 'y', -1, -1, -1,
     MNT_SHORTCUT_KEY},
    {"messagemode2", MNT_SHORTCUT_CHATTEAM, ID_CHAT2, ANIM_CHAT, 't', -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"messagemode3", MNT_SHORTCUT_CHATTARGET, ID_CHAT3, ANIM_CHAT, -1, -1, -1,
     -1, MNT_SHORTCUT_KEY},
    {"messagemode4", MNT_SHORTCUT_CHATATTACKER, ID_CHAT4, ANIM_CHAT, -1, -1, -1,
     -1, MNT_SHORTCUT_KEY},
    //	{"messagemode5",		 	MNT_SHORTCUT_CHATCLASS,			ID_CHAT5,
    //ANIM_CHAT,		-1,				-1,		-1,
    //-1,MNT_SHORTCUT_KEY},
    {"+button2", MNT_SHORTCUT_USEINVENTORY, ID_USEINVENTORY, ANIM_IDLE, K_SPACE,
     -1, -1, -1, MNT_SHORTCUT_KEY},
    {"flashlight", MNT_SHORTCUT_OBJECTIVES, ID_OBJECTIVES, ANIM_IDLE, 'q', -1,
     -1, -1, MNT_SHORTCUT_KEY},
    {"thirdPerson", MNT_SHORTCUT_TOGGLE3RDPERSON, ID_TOGGLE3DP, ANIM_IDLE,
     K_KP_5, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"thirdPersonCommit", MNT_SHORTCUT_COMMITANGLES, ID_COMMITANGLES, ANIM_IDLE,
     K_KP_ENTER, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"thirdPersonRevert", MNT_SHORTCUT_REVERTANGLES, ID_REVERTANGLES, ANIM_IDLE,
     K_KP_INS, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"thirdPersonReset", MNT_SHORTCUT_RESETANGLES, ID_RESETANGLES, ANIM_IDLE,
     K_KP_DEL, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonForward", MNT_SHORTCUT_MODELVIEW_FORWARD, ID_ZOOMFORWARD,
     ANIM_IDLE, K_KP_UPARROW, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonBackward", MNT_SHORTCUT_MODELVIEW_BACKWARD, ID_ZOOMBACKWARD,
     ANIM_IDLE, K_KP_DOWNARROW, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonLeft", MNT_SHORTCUT_MODELVIEW_LEFT, ID_PANLEFT, ANIM_IDLE,
     K_KP_STAR, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonRight", MNT_SHORTCUT_MODELVIEW_RIGHT, ID_PANRIGHT, ANIM_IDLE,
     K_KP_MINUS, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonUp", MNT_SHORTCUT_MODELVIEW_UP, ID_PANUP, ANIM_IDLE,
     K_KP_PGUP, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonDown", MNT_SHORTCUT_MODELVIEW_DOWN, ID_PANDOWN, ANIM_IDLE,
     K_KP_DEL, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonAngleLeft", MNT_SHORTCUT_MODELVIEW_ROTLEFT, ID_ROTATELEFT,
     ANIM_IDLE, K_KP_LEFTARROW, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonAngleRight", MNT_SHORTCUT_MODELVIEW_ROTRIGHT, ID_ROTATERIGHT,
     ANIM_IDLE, K_KP_RIGHTARROW, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonPitchUp", MNT_SHORTCUT_MODELVIEW_PITCHUP, ID_PITCHUP,
     ANIM_IDLE, K_KP_HOME, -1, -1, -1, MNT_SHORTCUT_KEY},
    {"+thirdPersonPitchDown", MNT_SHORTCUT_MODELVIEW_PITCHDOWN, ID_PITCHDOWN,
     ANIM_IDLE, K_KP_END, -1, -1, -1, MNT_SHORTCUT_KEY},
    //	{"+analysis",				MNT_SHORTCUT_OBJECTIVES,		ID_OBJECTIVES,
    //ANIM_IDLE,		-1,				-1,		-1,
    //-1,MNT_SHORTCUT_KEY},
...
static configcvar_t g_configcvars[] = {
    {"cl_run", 0, 0},      {"m_pitch", 0, 0},     {"cg_autoswitch", 0, 0},
    {"sensitivity", 0, 0}, {"in_joystick", 0, 0}, {"joy_threshold", 0, 0},
    {"m_filter", 0, 0},    {"cl_freelook", 0, 0}, {"cl_anglespeedkey", 0, 0},
    {"joy_xbutton", 0, 0}, {"joy_ybutton", 0, 0}, {NULL, 0, 0}};
...
static void *g_move_controls[] = {
    &s_move_walkforward_action, &s_move_backpedal_action,
    &s_move_turnleft_action, &s_move_turnright_action, &s_move_run_action,
    &s_move_stepleft_action, &s_move_stepright_action, &s_move_sidestep_action,
    &s_move_moveup_action, &s_move_movedown_action,
    //	&s_alwaysrun_box,
    NULL};
...
static void **g_controls[] = {g_attack_controls,     g_command_controls,
                              g_attacklook_controls, g_move_controls,
                              g_modelview_controls,  g_mouse_controls,
                              g_command_controls};
...
static void Controls_UpdateModel(int32_t anim) {
  ...
  switch (anim) {
    // TiM : the anim selection code from PMove was adapted to this so it'll
    // play the same animations per weapon from ingame :)
  case ANIM_RUN:
    s_controls.playerTorso =
        UI_GetAnim(ANIM_RUN, s_controls.playerWeapon, qtrue);
    s_controls.playerLegs =
        UI_GetAnim(ANIM_RUN, s_controls.playerWeapon, qfalse); // LEGS_RUN
    break;

  case ANIM_WALK:
    s_controls.playerTorso =
        UI_GetAnim(ANIM_WALK, s_controls.playerWeapon, qtrue);
    s_controls.playerLegs =
        UI_GetAnim(ANIM_WALK, s_controls.playerWeapon, qfalse); // LEGS_WALK
    break;

  case ANIM_BACK:
    s_controls.playerTorso =
        UI_GetAnim(ANIM_BACK, s_controls.playerWeapon, qtrue);
    s_controls.playerLegs =
        UI_GetAnim(ANIM_BACK, s_controls.playerWeapon, qfalse); // LEGS_BACK
    break;

  case ANIM_JUMP:
    s_controls.playerTorso =
        UI_GetAnim(ANIM_JUMP, s_controls.playerWeapon, qtrue);
    s_controls.playerLegs =
        UI_GetAnim(ANIM_JUMP, s_controls.playerWeapon, qfalse); // LEGS_JUMP
    break;

  case ANIM_CROUCH:
    s_controls.playerTorso =
        UI_GetAnim(ANIM_CROUCH, s_controls.playerWeapon, qtrue);
    s_controls.playerLegs =
        UI_GetAnim(ANIM_CROUCH, s_controls.playerWeapon, qfalse); // LEGS_IDLECR
    break;
  ...
  case ANIM_STEPRIGHT:
    s_controls.playerTorso =
        UI_GetAnim(ANIM_WALK, s_controls.playerWeapon, qtrue);
    s_controls.playerLegs =
        UI_GetAnim(ANIM_WALK, s_controls.playerWeapon, qfalse);
    s_controls.playerMoveangles[YAW] = s_controls.playerViewangles[YAW] - 90;
    break;
  ...
  case ANIM_ATTACK:
    s_controls.playerTorso =
        UI_GetAnim(ANIM_ATTACK, s_controls.playerWeapon, qtrue);
    break;
  ...
  UI_PlayerInfo_SetInfo(
      &s_controls.playerinfo, s_controls.playerLegs, s_controls.playerTorso,
      s_controls.playerViewangles, s_controls.playerMoveangles,
      static_cast<weapon_t>(s_controls.playerWeapon),
      trap_Cvar_VariableValue("height"), trap_Cvar_VariableValue("weight"),
...
static void Controls_DrawKeyBinding(void *self) {
  ...
  if ((c) && (g_bindings[a->generic.id].desc)) {
    if (menu_normal_text[g_bindings[a->generic.id].desc]) {
      UI_DrawProportionalString(
          a->generic.parent->descX, a->generic.parent->descY,
          menu_normal_text[g_bindings[a->generic.id].desc],
  ...
  if (!width) {
    ...
    UI_DrawHandlePic(x, y, 19, MENU_BUTTON_MED_HEIGHT,
                     uis.graphicButtonLeftEnd);
    UI_DrawHandlePic(x + (SMALLCHAR_WIDTH * 11), y, -19, MENU_BUTTON_MED_HEIGHT,
                     uis.graphicButtonLeftEnd); // right
    UI_DrawHandlePic(x + 8, y, (SMALLCHAR_WIDTH * 11), MENU_BUTTON_MED_HEIGHT,
                     uis.whiteShader);
    ...
    trap_R_SetColor(colorTable[color]);
    // Left end
    UI_DrawHandlePic(x, y, 16, MENU_BUTTON_MED_HEIGHT,
                     uis.graphicButtonLeftEnd);
    // Right end
    UI_DrawHandlePic(x + width, y, -16, MENU_BUTTON_MED_HEIGHT,
                     uis.graphicButtonLeftEnd); // right
    // Middle
  ...
  if (g_bindings[a->generic.id].label) {
    UI_DrawProportionalString(x + a->textX, y + a->textY,
                              menu_normal_text[g_bindings[a->generic.id].label],
                              UI_LEFT | UI_SMALLFONT,
                              colorTable[buttontextcolor]);
  }

  // Binding text
  UI_DrawProportionalString(bindingX, y, name, UI_SMALLFONT,
                            colorTable[bindingtextcolor]);
  UI_LogFuncEnd();
}
...
static void Controls_DrawPlayer(void *self) {
  ...
  b = (menubitmap_s *)self;
  UI_DrawPlayer(b->generic.x, b->generic.y, b->width, b->height, origin,
                &s_controls.playerinfo, uis.realtime / 2);
  UI_LogFuncEnd();
}
...
static void Controls_GetConfig(void) {
  ...
  s_controls.smoothmouse.curvalue =
      UI_ClampCvar(0, 1, Controls_GetCvarValue("m_filter"));
  s_controls.alwaysrun.curvalue =
      UI_ClampCvar(0, 1, Controls_GetCvarValue("cl_run"));
  s_controls.autoswitch.curvalue =
      UI_ClampCvar(0, 2, Controls_GetCvarValue("cg_autoswitch"));
  s_controls.sensitivity.curvalue =
      UI_ClampCvar(2, 30, Controls_GetCvarValue("sensitivity"));
  s_controls.joyenable.curvalue =
      UI_ClampCvar(0, 1, Controls_GetCvarValue("in_joystick"));
  s_controls.joythreshold.curvalue =
      UI_ClampCvar(0.05, 0.75, Controls_GetCvarValue("joy_threshold"));
  s_controls.freelook.curvalue =
      UI_ClampCvar(0, 1, Controls_GetCvarValue("cl_freelook"));
  s_keyturnspeed_slider.curvalue =
      UI_ClampCvar(1, 5, Controls_GetCvarValue("cl_anglespeedkey"));
  s_joyxbutton_box.curvalue =
      UI_ClampCvar(0, 1, Controls_GetCvarValue("joy_xbutton"));
  s_joyybutton_box.curvalue =
      UI_ClampCvar(0, 1, Controls_GetCvarValue("joy_ybutton"));
  UI_LogFuncEnd();
}
...
static sfxHandle_t Controls_MenuKey(int32_t key) {
  ...
  //	id      =
  //((menucommon_s*)(s_controls.menu.items[s_controls.menu.cursor]))->id;
...
=================
*/
void SetupMenu_TopButtons(menuframework_s *menu, int32_t menuType,
                          menuaction_s *s_video_apply_action) {
  UI_LogFuncBegin();
...
void M_WeaponsMenu_Graphics(void) {
  ...
  UI_DrawProportionalString(74, 66, "56-129", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 84, "33", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 188, "9893", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 395, "12799", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  ...
  UI_DrawProportionalString(607, 174, "981235", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(607, 406, "5672141", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);

  if (s_attack_waiting_action.generic.flags & QMF_HIDDEN) {
    UI_DrawProportionalString(207, 411, menu_normal_text[MNT_BACKSPACE],
                              UI_SMALLFONT, colorTable[CT_WHITE]);
  }
  UI_LogFuncEnd();
}
...
static void WeaponsMenu_Precache(void) {
  ...
  for (i = 0; i < AMG_MAX; ++i) {
    if (attackmenu_graphics[i].type == MG_GRAPHIC) {
      attackmenu_graphics[i].graphic =
          trap_R_RegisterShaderNoMip(attackmenu_graphics[i].file);
    }
  }
  UI_LogFuncEnd();
}
...
static void SetupActionButtons_Init(int32_t section) {
  ...
  for (i = 0; i < 99; i++) // The 99 is to avoid runaway loops
  {
    ...
    // if ( ((menuaction_s*)controlptr[i])->generic.id == ID_EQUIP ||
    // ((menuaction_s*)controlptr[i])->generic.id == ID_WEAPON0 ) 	y += 40; else
    y += 20;
  }
  UI_LogFuncEnd();
}
...
static void Weapons_MenuInit(void) {
  ...
  s_attack_weapon0_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_attack_weapon1_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_attack_weapon2_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_attack_weapon3_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_attack_weapon4_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_attack_weapon5_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_attack_weapon_next_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_attack_weapon_prev_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
...
static void Controls_UpdateNew(void) {
  ...
  if (s_controls.waitingforkey) {
    ((menucommon_s *)(current_menu->items[current_menu->cursor]))->flags &=
        ~QMF_HIGHLIGHT;
    UI_LogFuncEnd();
    return;
  }
...
void ControlsVideoDataAction(bool result) {
  if (result) // Yes - do it
  {
...
static void Controls_MenuEventVideo(void *ptr, int32_t event) {
  ...
  if (vid_apply_action->generic.flags &
      QMF_BLINK) // Video apply changes button is flashing
  {
    UI_ConfirmMenu(menu_normal_text[MNT_LOOSEVIDSETTINGS], 0,
                   ControlsVideoDataAction);
...
static void Controls_MenuEvent(void *ptr, int32_t event) {
  ...
  case ID_PLAYER:
    //			UI_PopMenu();				// Get rid of whatever is
    //ontop
...
void M_ControlsMoveMenu_Graphics(void) {
  ...
  UI_DrawProportionalString(74, 66, "7-2345", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 84, "803", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 188, "32811", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 395, "560-99", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  ...
  UI_DrawProportionalString(607, 174, "634579", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(607, 406, "2815689", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
...
static void ControlsMove_MenuInit(void) {
  ...
  s_move_walkforward_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_move_backpedal_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_move_turnleft_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_move_turnright_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_move_stepleft_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_move_stepright_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_move_sidestep_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_move_moveup_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_move_movedown_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
...
void M_ControlsLookMenu_Graphics(void) {
  ...
  UI_DrawProportionalString(74, 66, "3567", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 84, "9003", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 188, "1425", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 395, "6780-1", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  ...
  UI_DrawProportionalString(607, 174, "556541", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(607, 406, "909090", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
...
static void ControlsAttackLook_MenuInit(void) {
  ...
  s_attack_attack_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_attack_alt_attack_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_attack_use_inv_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_look_lookup_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_look_lookdown_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_look_mouselook_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_look_centerview_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
...
void M_ControlsMouseJoyStickMenu_Graphics(void) {
  ...
  UI_DrawProportionalString(MENU_TITLE_X, 440,
                            menu_normal_text[MNT_MOUSEJOYSTICK_SETUP],
                            UI_RIGHT | UI_SMALLFONT, colorTable[CT_LTORANGE]);
  UI_MenuBottomLineEnd_Graphics(menu_normal_text[MNT_MOUSEJOYSTICK_SETUP],
                                CT_LTBROWN1, NULL);

  trap_R_SetColor(colorTable[CT_DKBLUE2]);
  UI_DrawHandlePic(235, 166, 377, 20,
                   uis.whiteShader); // Long thick line above mouse stuff
  UI_DrawHandlePic(185, 184, 50, 100,
                   uis.whiteShader); // Thick column by mouse stuff
  UI_DrawHandlePic(185, 284, 427, 8,
                   uis.whiteShader); // Long thin line below mouse stuff
  UI_DrawHandlePic(185, 166, 64, 32, s_joystick_mouse.mouse1); // Rounded corner

  UI_DrawHandlePic(185, 300, 427, 8,
                   uis.whiteShader); // Long thin line below joystick stuff
  UI_DrawHandlePic(185, 305, 50, 100,
                   uis.whiteShader); // Thick column by joystick stuff
  UI_DrawHandlePic(235, 406, 377, 20,
                   uis.whiteShader); // Long thick line above joystick stuff
  UI_DrawHandlePic(185, 401, 64, 32, s_joystick_mouse.mouse2); // Rounded corner

  UI_DrawProportionalString(608, 169, menu_normal_text[MNT_MOUSE],
                            UI_RIGHT | UI_SMALLFONT, colorTable[CT_LTGOLD1]);
  UI_DrawProportionalString(608, 409, menu_normal_text[MNT_JOYSTICK],
                            UI_RIGHT | UI_SMALLFONT, colorTable[CT_LTGOLD1]);

  UI_DrawProportionalString(74, 66, "4568", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 84, "71-49", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 188, "67014", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 395, "356-905", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
...
static void ControlsMouseJoyStick_MenuInit(void) {
  ...
  Menu_AddItem(&s_controlsmouse_menu,
               (void *)&s_joyxbutton_box); // Commented out until needed
  Menu_AddItem(&s_controlsmouse_menu,
               (void *)&s_joyybutton_box); // Commented out until needed
...
void M_ControlsDefaultMenu_Graphics(void) {
  ...
  UI_DrawHandlePic(30, 203, 47, 186,
                   uis.whiteShader); // Long left column square on bottom 3rd
  ...
  UI_DrawProportionalString(345, 210, menu_normal_text[MNT_DEFAULT_WARNING1],
                            UI_BIGFONT | UI_BLINK | UI_CENTER,
                            colorTable[CT_RED]);
  UI_DrawProportionalString(345, 263, menu_normal_text[MNT_DEFAULT_WARNING2],
                            UI_SMALLFONT | UI_CENTER, colorTable[CT_RED]);
  UI_DrawProportionalString(345, 283, menu_normal_text[MNT_DEFAULT_WARNING3],
                            UI_SMALLFONT | UI_CENTER, colorTable[CT_RED]);
  UI_DrawProportionalString(345, 321, menu_normal_text[MNT_CONTINUE_WARNING],
                            UI_SMALLFONT | UI_CENTER, colorTable[CT_RED]);
...
void M_ControlsOtherMenu_Graphics(void) {
  ...
  UI_DrawHandlePic(210, 204, 402, 8,
                   uis.whiteShader); // Long thin line below turn speed
  UI_DrawHandlePic(545, 212, 67, 140, uis.whiteShader); // Thick right column
  UI_DrawHandlePic(210, 344, 402, 8,
                   uis.whiteShader); // Long thin line below autoswitch
  UI_DrawHandlePic(210, 352, 10, 83, uis.whiteShader); // Thin left column

  UI_DrawProportionalString(608, 340, "1701 - B", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);

  UI_DrawProportionalString(280, 419, "500987", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_DKGOLD1]);
  UI_DrawProportionalString(358, 419, "456732", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_DKGOLD1]);
  UI_DrawProportionalString(436, 419, "67024", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_DKGOLD1]);
  UI_DrawProportionalString(514, 419, "166110", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_DKGOLD1]);
  UI_DrawProportionalString(592, 419, "575", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_DKGOLD1]);
  ...
  UI_DrawProportionalString(74, 66, "5-0987", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 84, "16116", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 188, "28430", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 395, "6900", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
...
void ControlsOther_Cache(void) {
  UI_LogFuncBegin();
  s_controlsother.mon_bar =
      trap_R_RegisterShaderNoMip("menu/common/mon_bar.tga");
  UI_LogFuncEnd();
}
...
void M_ControlsCommandMenu_Graphics(void) {
  ...
  UI_DrawProportionalString(74, 66, "6-7", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 84, "8252", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 188, "21231", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 395, "96709", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  ...
  UI_DrawProportionalString(607, 174, "423", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(607, 406, "2-2334", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
...
static void ControlsCommand_MenuInit(void) {
  ...
  s_thirdperson_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_thirdpersoncommit_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_thirdpersonrevert_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_thirdpersonreset_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  Menu_AddItem(&s_controlscommand_menu,
               (void *)&s_drop_action); // RPG-X | Marcin | 04/12/2008
...
void M_ControlsModelView_Graphics(void) {
  ...
  UI_DrawProportionalString(74, 66, "2-8", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 84, "6154", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 188, "604", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(74, 395, "3699", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  ...
  UI_DrawProportionalString(607, 174, "867", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
  UI_DrawProportionalString(607, 406, "2-2135", UI_RIGHT | UI_TINYFONT,
                            colorTable[CT_BLACK]);
...
static void ControlsModelView_MenuInit(void) {
  ...
  s_zoomforward_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_zoombackward_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
  ...
  s_rotateright_action.generic.flags =
      QMF_LEFT_JUSTIFY | QMF_HIGHLIGHT_IF_FOCUS;
