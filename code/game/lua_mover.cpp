...
static int Mover_SetAngles(lua_State *L) {
  ...
  if (Lua_IsVector(L, 2)) {
    ...
    newAngles[0] = luaL_checkinteger(L, 2);
    newAngles[1] = luaL_checkinteger(L, 3);
    newAngles[2] = luaL_checkinteger(L, 4);
  }
...
static int Mover_SetPosition(lua_State *L) {
  ...
  if (Lua_IsVector(L, 2)) {
    ...
    newOrigin[0] = luaL_checkinteger(L, 2);
    newOrigin[1] = luaL_checkinteger(L, 3);
    newOrigin[2] = luaL_checkinteger(L, 4);
  }
...
static int Mover_ToAngles(lua_State *L) {
  ...
  if (Lua_IsVector(L, 3)) {
    ...
    newAngles[0] = luaL_checkinteger(L, 3);
    newAngles[1] = luaL_checkinteger(L, 4);
    newAngles[2] = luaL_checkinteger(L, 5);
  }
...
static int Mover_ToPosition(lua_State *L) {
  ...
  if (Lua_IsVector(L, 3)) {
    ...
    newOrigin[0] = luaL_checkinteger(L, 3);
    newOrigin[1] = luaL_checkinteger(L, 4);
    newOrigin[2] = luaL_checkinteger(L, 5);
  }
...
int Luaopen_Mover(lua_State *L) {
  lua_newtable(L);
  luaL_setfuncs(L, lib_mover, 0);
  lua_pushvalue(L, -1);
  lua_setglobal(L, "mover");
  return 1;
}
#endif
