...
static int Entity_MMBRefit(lua_State *L) {
  ...
  if (!Q_stricmp(arg2, "_brig") // I stole this directly from g_cmds.c, Cmd_CallVote_f
      ...
      || !Q_stricmp(arg2, "voy1") || !Q_stricmp(arg2, "voy13") || !Q_stricmp(arg2, "voy14") || !Q_stricmp(arg2, "voy15")
      || !Q_stricmp(arg2, "voy16") || !Q_stricmp(arg2, "voy17") || !Q_stricmp(arg2, "voy2") || !Q_stricmp(arg2, "voy20")
      || !Q_stricmp(arg2, "voy3") || !Q_stricmp(arg2, "voy4") || !Q_stricmp(arg2, "voy5") || !Q_stricmp(arg2, "voy6")
...
static int Entity_ToString(lua_State *L) {
  ...
  Com_sprintf(buf,
              sizeof(buf),
              "entity: class=%s name=%s id=%i pointer=%p\n",
              gent->classname,
              gent->targetname,
              gent - g_entities,
              gent);
...
static int Entity_SetupTrigger(lua_State *L) {
  ...
  if (Lua_IsVector(L, 2)) {
    ...
    size[0] = luaL_checkinteger(L, 2);
    size[1] = luaL_checkinteger(L, 3);
    size[2] = luaL_checkinteger(L, 4);
  }
...
static int Entity_GetParm(lua_State *L) {
  ...
  switch (parm) {
    case 1: res = ent->luaParm1;
      break;
    case 2: res = ent->luaParm2;
      break;
    case 3: res = ent->luaParm3;
      break;
    case 4: res = ent->luaParm4;
      break;
    default: res = NULL;
      break;
  }
...
static int Entity_SetParm(lua_State *L) {
  ...
  switch (parm) {
    case 1: s = ent->luaParm1;
      break;
    case 2: s = ent->luaParm2;
      break;
    case 3: s = ent->luaParm3;
      break;
    case 4: s = ent->luaParm4;
      break;
  }
